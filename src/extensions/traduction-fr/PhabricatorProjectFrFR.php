...
final class PhabricatorProjectFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Type a project name...' => 'Entrez un nom de projet.',
      ...
      'This project does not have any members.' => 'Ce projet n\'a pas de membres.',
      'Not In: %s' => 'Pas dans: %s',
      ...
      'New Empty Board' => 'Nouveau Workboard',
      'Create a new board with just a backlog column.' => 'Créer un nouveau tableau avec uniquement la colonne "Backlog".',
      'Import board columns from another project.' => 'Importer les colonnes d`\'un tableau d\'un autre projet.',
      'Make the workboard the default view for this project.' => 'Faire du tableau la vue par défaut du projet',
      ...
      'Watching' => 'Suivis',
      'Joined' => 'Rejoints',
      'Edit Queries...' => 'Editer les recherches...',
      ...
      'Create Subprojetc' => 'Créer un sous-projet',
      'Project %s' => 'Projet %s',
      'Browse Projects' => 'Afficher les projets',
      '%s created this project.' => '%s a créé ce projet.',
      '%s set this project\'s icon to %s.' => '%s à défini l\'icone du projet à %s.',
      '%s locked this project`\'s membership..' => '%s à bloqué l\'adhésion au projet.',
      ...
      'Move Tasks to Project...' => 'Déplacer la tâche vers le projet...',
      'View Tasks as Query' => 'Voir les tâches comme une recherche',
      ...
      'Change Project Tags' => 'Changer les Tags projets',
      'Users with access may join and leave this project.' => 'Les utilisateurs avec accés peuvent rejoindre ou quitter le groupe.',
      'Users with access may join this project, but may not leave.' => 'Les utilisateurs avec accés peuvent rejoindre le groupe mais pas le quitter.',
      'Create Workboard' => 'Créer un Workboard',
      'Joinable By' => 'Rejoignable par',
      ...
      'Manage Workboard' => 'Gérer le Workboard',
      'Disable Workboard' => 'Désactiver le Workboard',
      'Enable Workboard' => 'Activer le Workboard',
      'New Trigger' => 'Nouvel évènement',
      'Create Trigger' => 'Nouvel évènement',
      'New Trigger...' => 'Nouvel évènement...',
      'Remove Trigger' => 'Supprimer évènement',
      'Custom Trigger' => 'Evènement personalisé',
      'When a card is dropped into a column which uses this trigger:' => 'Quand une carte est mis dans une colonne qui utilise cet évènement :',
      '%s edited %s project(s), added %s: %s; removed %s: %s.' => '%s a mis à jour %s projet(s), ajouté(s) %s : %s; supprimé(s) %s : %s.',
      '%s added %s parent task(s): %s.' => '%s a jouté %s parent(s) : %s.',
    );
  }
